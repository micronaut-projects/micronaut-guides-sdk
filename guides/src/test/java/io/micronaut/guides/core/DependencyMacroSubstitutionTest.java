...
public class DependencyMacroSubstitutionTest {
    ...
    void testSubstitute(){
        ...
        String resJava = dependencyMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("micronaut-jaxrs"), new GuidesOption(BuildTool.GRADLE, Language.JAVA, TestFramework.SPOCK)));
        String expectedJava = """
                ==== Dependencies
