...
import io.micronaut.guides.core.rss.RssFeedConfiguration;
...
class RssFeedGenerationTest {
    ...
    @Inject
    RssFeedConfiguration rssConfiguration;
    ...
    @Test
    void testRssFeed() {
        rssFeedFileGenerator.saveRssFeed(guides, tempDir);
        // read the generated file
        String feed = readFile(new File(tempDir, rssConfiguration.getFilename()));
