...
class TestMacroSubstitutionTest {
    ...
    void testSubstitute() {
        ...
        String resJava = testMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("micronaut-http-client"), new GuidesOption(BuildTool.GRADLE, Language.JAVA, TestFramework.JUNIT)));
        String expectedJava = """
                [source,java]
        ...
        String resKotlin = testMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("micronaut-http-client"), new GuidesOption(BuildTool.GRADLE, Language.KOTLIN, TestFramework.KOTEST)));
        ...
        String resGroovy = testMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("micronaut-http-client"), new GuidesOption(BuildTool.GRADLE, Language.GROOVY, TestFramework.SPOCK)));
    ...
    void TestSubstituteWithApp() {
        ...
        String resJava = testMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("spring-boot-to-micronaut-application-class", "springboot"), new GuidesOption(BuildTool.GRADLE, Language.JAVA, TestFramework.JUNIT)));
        String expectedJava = """
                [source,java]
    ...
    void TestSubstituteWithTags(){
        ...
        String resJava = testMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("micronaut-configuration"), new GuidesOption(BuildTool.GRADLE, Language.JAVA, TestFramework.JUNIT)));
        String expectedJava = """
                [source,java]
    ...
    void TestSubstituteWithMultiple(){
        ...
        String resJava = testMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("micronaut-configuration", "springboot"), new GuidesOption(BuildTool.GRADLE, Language.JAVA, TestFramework.JUNIT)));
        String expectedJava = """
                [source,java]
