...
class SourceMacroSubstitutionTest {
    ...
    void testSubstitute(){
        ...
        String resJava = sourceMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("micronaut-http-client"), new GuidesOption(BuildTool.GRADLE, Language.JAVA, TestFramework.SPOCK)));
        String expectedJava = """
                [source,java]
        ...
        String resKotlin = sourceMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("micronaut-http-client"), new GuidesOption(BuildTool.GRADLE, Language.KOTLIN, TestFramework.KOTEST)));
        ...
        String resGroovy = sourceMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("micronaut-http-client"), new GuidesOption(BuildTool.GRADLE, Language.GROOVY, TestFramework.JUNIT)));
