...
public class RawTestMacroSubstitutionTest {
    ...
    void testSubstitute() {
        String str = """
                ...
                rawTest:HomePage[]
                """;
        String resJava = rawTestMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("micronaut-security-jwt-cookie"), new GuidesOption(BuildTool.GRADLE, Language.JAVA, TestFramework.SPOCK)));
        String expectedJava = """
                Create three pages:
        ...
        String resKotlin = rawTestMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("micronaut-security-jwt-cookie"), new GuidesOption(BuildTool.GRADLE, Language.KOTLIN, TestFramework.SPOCK)));
        ...
        String resGroovy = rawTestMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("micronaut-security-jwt-cookie"), new GuidesOption(BuildTool.GRADLE, Language.GROOVY, TestFramework.SPOCK)));
