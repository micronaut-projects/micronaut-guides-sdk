...
public class TestResourceMacroSubstitutionTest {
    ...
    void testSubstitute() {
        ...
        String resJava = testResourceMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("micronaut-metrics-oci"), new GuidesOption(BuildTool.GRADLE, Language.JAVA, TestFramework.JUNIT)));
        String expectedJava = """
                [source,yaml]
