...
public class ZipIncludeMacroSubstitutionTest {
    ...
    void testSubstitute() {
        ...
        String resJava = zipIncludeMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("micronaut-kafka"), new GuidesOption(BuildTool.GRADLE, Language.JAVA, TestFramework.JUNIT)));
        String expectedJava = """
                    A fast way to start using Kafka is https://hub.docker.com/r/confluentinc/cp-kafka/[via Docker]. Create this `docker-compose.yml` file:
    ...
    void testSubstituteWithPath() {
        ...
        String resJava = zipIncludeMacroSubstitution.substitute(str, new GuideRender(GuideTestUtils.guideWithSlug("executable-jar"), new GuidesOption(BuildTool.GRADLE, Language.JAVA, TestFramework.JUNIT)));
        String expectedJava = """
                [source,sh]
                .ttfr.sh
                ----
